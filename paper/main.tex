...
\title{Do CLAP Models Need Meaning? A Case Study of Chinese Lyric Perturbations}
...
(1)~evidence that CLAP variants show \emph{model-dependent} sensitivity to lyric surface form: both LAION CLAP variants treat meaning-preserving paraphrases identically to originals (standard: $d{=}{-}0.02$, $p{=}0.82$; fused: $d{=}0.14$, $p{=}0.08$), while Microsoft CLAP does distinguish them ($d{=}0.45$), showing that paraphrase sensitivity is not universal across CLAP variants;
(2)~evidence that all three models agree nonsense hachimi lyrics produce moderately higher alignment than originals ($d{=}{-}0.24$ to $-0.37$), and that instrumental accompaniment attenuates this pattern ($d{=}{-}0.24$ full-mix vs.\ $d{=}{-}0.47$ vocal-only in LAION CLAP);
